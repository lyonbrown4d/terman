...
pub(crate) fn detach_builtin_tmux_clients(args: &[String]) -> Result<(), Box<dyn Error>> {
    ...
    match request_endpoint_response(&session_endpoint(&session), TmuxIpcRequest::DetachAll)? {
