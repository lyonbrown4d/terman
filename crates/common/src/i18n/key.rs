...
pub enum MessageKey {
    ...
    BuiltinHtopHelp,
    BuiltinHtopHelpPanel, BuiltinHtopTreeCollapse, BuiltinHtopTreeExpand, BuiltinHtopTreeToggleAll,
    BuiltinHtopSortMenuTitle,
    ...
    BuiltinTmuxPrefixStatus,
    BuiltinTmuxAttachWindowList,
...
impl MessageKey {
    pub(crate) fn fluent_id(self) -> &'static str {
        match self {
            ...
            Self::BuiltinHtopHelpPanel => "builtin-htop-help-panel", Self::BuiltinHtopTreeCollapse => "builtin-htop-tree-collapse", Self::BuiltinHtopTreeExpand => "builtin-htop-tree-expand", Self::BuiltinHtopTreeToggleAll => "builtin-htop-tree-toggle-all",
            Self::BuiltinHtopSortMenuTitle => "builtin-htop-sort-menu-title",
            ...
            Self::BuiltinTmuxPrefixStatus => "builtin-tmux-prefix-status",
            Self::BuiltinTmuxAttachWindowList => "builtin-tmux-attach-window-list",
            ...
            Self::BuiltinTmuxPaneSizeRequired => "builtin-tmux-pane-size-required",
