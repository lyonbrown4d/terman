...
pub enum MessageKey {
    ...
    BuiltinTmuxAttachWindowList, BuiltinTmuxPaneChooser,
...
impl MessageKey {
    pub(crate) fn fluent_id(self) -> &'static str {
        match self {
            ...
            Self::BuiltinTmuxAttachWindowList => "builtin-tmux-attach-window-list", Self::BuiltinTmuxPaneChooser => "builtin-tmux-pane-chooser",
