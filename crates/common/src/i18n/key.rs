...
pub enum MessageKey {
    ...
    BuiltinTmuxPrefixStatus, BuiltinTmuxCommandPrompt, BuiltinTmuxCommandParseError,
...
impl MessageKey {
    pub(crate) fn fluent_id(self) -> &'static str {
        match self {
            ...
            Self::BuiltinTmuxPrefixStatus => "builtin-tmux-prefix-status", Self::BuiltinTmuxCommandPrompt => "builtin-tmux-command-prompt", Self::BuiltinTmuxCommandParseError => "builtin-tmux-command-parse-error",
