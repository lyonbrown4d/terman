...
builtin-screen-control-command-unsupported = Unsupported screen control command `{$command}`. Currently supported: quit, kill, bell, echo, wall, stuff, pastefile, source, detach, pow_detach, resize, select, version, info, windows, hardcopy, clear, reset, eval, at, colon, sessionname.
