...
builtin-screen-control-command-unsupported = Unsupported screen control command `{$command}`. Currently supported: quit, kill, stuff, detach, resize, info, hardcopy, clear, reset.
