...
builtin-screen-control-command-unsupported = Unsupported screen control command `{$command}`. Currently supported: quit, kill, echo, stuff, pastefile, detach, resize, info, hardcopy, clear, reset.
