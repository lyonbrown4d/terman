...
builtin-screen-attach-help = screen keys: Ctrl-A d detach | Ctrl-A k kill session | Ctrl-A h hardcopy | Ctrl-A i info | Ctrl-A ? help | Ctrl-A Ctrl-A send literal Ctrl-A
