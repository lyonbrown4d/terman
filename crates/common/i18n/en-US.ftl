...
builtin-screen-attach-help = screen keys: Ctrl-A c new window | Ctrl-A d detach | Ctrl-A D detach all | Ctrl-A k kill current window | Ctrl-A C clear | Ctrl-A Z reset | Ctrl-A r sync size | Ctrl-A h hardcopy | Ctrl-A ] paste buffer | Ctrl-A i info | Ctrl-A n next | Ctrl-A p previous | Ctrl-A 0..9 select window | Ctrl-A * displays | Ctrl-A t time | Ctrl-A v version | Ctrl-A w windows | Ctrl-A " windowlist | Ctrl-A ? help | Ctrl-A Ctrl-A last window | Ctrl-A a send literal Ctrl-A
...
builtin-screen-control-command-unsupported = Unsupported screen control command `{$command}`. Currently supported: quit, kill, bell, help, echo, wall, stuff, screen, paste, pastefile, readbuf, writebuf, source, detach, pow_detach, resize, select, next, prev, other, scrollback, defscrollback, logfile, log, title, aka, sleep, time, version, info, displays, windows, windowlist, hardcopy, clear, reset, eval, at, colon, sessionname.
...
builtin-screen-control-help = Supported screen -X commands: quit, kill, bell, help, echo, wall, stuff, screen, paste, pastefile, readbuf, writebuf, source, detach, pow_detach, resize, select, next, prev, other, scrollback, defscrollback, logfile, log, title, aka, sleep, time, version, info, displays, windows, windowlist, hardcopy, clear, reset, eval, at, colon, sessionname.
...
builtin-screen-control-writebuf-path-required = Specify an output path as screen -X writebuf <path>.
