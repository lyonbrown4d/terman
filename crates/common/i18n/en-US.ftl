...
builtin-screen-attach-help = screen keys: Ctrl-A c/Ctrl-C new window | Ctrl-A d/Ctrl-D detach | Ctrl-A D detach all | Ctrl-A k/Ctrl-K kill current window | Ctrl-A C clear | Ctrl-A Z reset | Ctrl-A r sync size | Ctrl-A l redisplay | Ctrl-A h hardcopy | Ctrl-A H log | Ctrl-A . dumptermcap | Ctrl-A ]/Ctrl-] paste buffer | Ctrl-A q xon | Ctrl-A s xoff | Ctrl-A i info | Ctrl-A n/Ctrl-N/Space next | Ctrl-A p/Ctrl-P/Backspace previous | Ctrl-A 0..9 select window | Ctrl-A * displays | Ctrl-A t time | Ctrl-A v version | Ctrl-A , license | Ctrl-A F fit | Ctrl-A W width | Ctrl-A w/Ctrl-W windows | Ctrl-A " windowlist | Ctrl-A ? help | Ctrl-A Ctrl-A last window | Ctrl-A a send literal Ctrl-A
