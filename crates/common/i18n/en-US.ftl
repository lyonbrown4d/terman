...
builtin-screen-control-command-unsupported = Unsupported screen control command `{$command}`. Currently supported: quit, stuff, detach, resize, info, hardcopy, clear.
