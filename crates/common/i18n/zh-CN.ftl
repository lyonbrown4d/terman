...
builtin-screen-control-command-unsupported = 暂不支持 screen 控制命令 `{$command}`。目前支持：quit、kill、bell、help、echo、wall、stuff、screen、paste、pastefile、readbuf、removebuf、writebuf、source、detach、pow_detach、resize、select、next、prev、other、scrollback、defscrollback、logfile、log、title、aka、sleep、time、version、info、displays、windows、windowlist、hardcopy、clear、reset、eval、at、colon、sessionname。
...
builtin-screen-control-help = 支持的 screen -X 命令：quit、kill、bell、help、echo、wall、stuff、screen、paste、pastefile、readbuf、removebuf、writebuf、source、detach、pow_detach、resize、select、next、prev、other、scrollback、defscrollback、logfile、log、title、aka、sleep、time、version、info、displays、windows、windowlist、hardcopy、clear、reset、eval、at、colon、sessionname。
