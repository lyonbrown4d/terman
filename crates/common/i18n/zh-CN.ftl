...
builtin-screen-control-command-unsupported = 暂不支持 screen 控制命令 `{$command}`。目前支持：quit、kill、bell、echo、stuff、pastefile、detach、resize、info、hardcopy、clear、reset。
builtin-screen-control-echo-required = 请为 screen -X echo 指定要广播的文本。
